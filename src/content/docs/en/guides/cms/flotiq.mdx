...
To connect your project with Flotiq, install the [Flotiq SDK](https://github.com/flotiq/flotiq-codegen-ts)

```bash
npx flotiq-codegen-ts
```

Update your tsconfig.json file and exclude the Flotiq SDK from TypeScript checks:
...
---
import type { Blogpost } from "../../../flotiqApi/src";
import { flotiq } from "../../lib/flotiq";
